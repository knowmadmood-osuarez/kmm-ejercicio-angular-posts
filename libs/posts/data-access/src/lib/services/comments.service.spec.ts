...
describe('CommentsService', () => {
  ...
  /** Helper: call loadForPost and flush the resulting HTTP request. */
  ...
  describe('loadForPost', () => {
    it('triggers a GET /comments?postId=N request', () => {
    ...
    it('resets page to 1 when loading a new post', () => {
      // Load post 10 page 1
      loadAndFlush(10);
